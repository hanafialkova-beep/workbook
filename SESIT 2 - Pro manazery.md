...
## Pro manažery a lídry · Od teorie k praxi
...
1. **Zmapujte AI nástroje ve firmě** — Zjistěte, co máte, co chybí a kde jsou příležitosti
2. **Nastartujte AI adopci v týmu** — Systematický plán pro zavedení AI
3. **Vytvořte aplikaci nebo automatizaci pro tým** — Praktický nástroj, který usnadní práci všem
4. **Práce s AI agenty** — Specializovaní asistenti pro manažerské úkoly
5. **Automatizujte opakující se procesy** — Komplexní automatizace pro celý tým
6. **Zhodnoťte pokrok a plánujte** — Měření úspěchu a další kroky
...
- [ ] Kompletní mapa AI nástrojů ve firmě
- [ ] Identifikované mezery a nevyužité licence
- [ ] Seznam quick wins (rychlé příležitosti)
- [ ] Návrh priorit pro AI adopci

### 💭 Reflexe

- Co vás při mapování překvapilo?
...
- Vytvořte sdílené AI asistenty pro tým (GPTs, Projects, Gems — viz Sešit 1, Cvičení 7)
...
- Identifikujte a vyškolte **AI šampióny** v týmu (lidi, kteří AI táhnou a pomáhají ostatním)
...
- [ ] Identifikované bariéry adopce v týmu
- [ ] 3 horizonty s konkrétními akcemi
- [ ] Připravené materiály pro Horizont 1
- [ ] Jasná bezpečnostní pravidla

### 💭 Reflexe

- Jaké bariéry jsou ve vašem týmu nejsilnější?
- Kdo by mohl být váš "AI champion"?
- Jak budete měřit úspěch?

---

## Cvičení 3: Vytvořte aplikaci nebo automatizaci pro tým

> **💡 Vytvořte praktický nástroj, který usnadní práci celému týmu — bez programování.**

**⏱️ 45–60 minut · Úroveň: Střední/Pokročilá**

**Cíl:** Vytvořit jednoduchou aplikaci nebo automatizaci, která řeší konkrétní problém vašeho týmu.
...
Například v Replit:
1. Otevřete https://replit.com → Create Repl → HTML, CSS, JS
2. Popište AI, co chcete: *"Vytvoř mi webovou kalkulačku pro cenové nabídky. Uživatel vybere produkty z nabídky, zadá množství a kalkulačka spočítá cenu s DPH a slevou."*
3. Iterujte: testujte → upravujte → testujte znovu

💡 **Tip:** Začněte jednoduše. První verze nemusí být dokonalá. Důležité je, aby fungovala a řešila problém.
...
- Pokud nástroj pracuje s firemními daty, zajistěte odpovídající zabezpečení

### Výstup

- [ ] Identifikovaný problém pro automatizaci
- [ ] Vybraný vhodný nástroj
- [ ] Funkční první verze aplikace/automatizace
- [ ] Zpětná vazba od kolegů

### 💭 Reflexe

- Kolik času týdně může nástroj ušetřit?
- Jaké další problémy byste chtěli automatizovat?

---

## Cvičení 4: Práce s AI agenty
...
| **Research to Prompt** | Výzkum → prompt | Přeměna výzkumu na použitelné AI zadání |
...
Chci slyšet pohledy: CTO, CFO, CISO, Head of HR, Line Manager.
```

💡 **Tip:** Agenty můžete použít v ChatGPT (jako GPTs), v Claude (jako Projects), nebo jednoduše vložit jejich instrukce do nového chatu.

### Výstup

- [ ] Vybraný agent pro konkrétní manažerský úkol
- [ ] Připravený kontext a vstupní data
- [ ] Vyzkoušený agent na reálném problému
- [ ] Použitelný výstup z agenta

### 💭 Reflexe

- Který agent vám přijde nejužitečnější?
- Jak byste agenty integrovali do práce týmu?
...
Zmapujete proces, navrhnete automatizaci, implementujete ji a otestujete.

### Kdy je automatizace vhodná

Automatizace se vyplatí, když:
...
- Kolik času automatizace ušetří?
- Jaké další procesy byste chtěli automatizovat?
...
Projdete si výsledky ze všech předchozích cvičení, kvantifikujete přínosy a vytvoříte plán pro další kvartál.
...
**5. Prezentujte výsledky**

Připravte krátkou prezentaci (5 minut) pro management:
- Co jsme vyzkoušeli
- Co to přineslo (čísla + příběhy)
- Co plánujeme dál
- Co potřebujeme (licence, čas, podpora)

### Výstup

- [ ] Přehled adopce v týmu (kdo, co, jak)
- [ ] Kvantifikované přínosy (hodiny, kvalita, ROI)
- [ ] Příběhy úspěchů
- [ ] Plán dalšího kvartálu
- [ ] Prezentace pro management

### 💭 Reflexe

- Co vás při hodnocení překvapilo?
- Jaký je váš nejsilnější argument pro rozšíření AI?
- Kde vidíte největší potenciál pro další kvartál?
...
### Specializovaní AI agenti (kompletní seznam)
- **Context Builder** — Vytváření kontextových dokumentů pro AI
- **Knowledge Extractor** — Extrakce znalostí z dokumentů
- **Product Architect** — Architektura produktů a systémů
- **Prompt Architect** — Tvorba pokročilých promptů
- **Research to Prompt** — Přeměna výzkumu na AI zadání
- **Expert Panel** — Panel expertů pro diskusi
- **Work Breakdown Structure** — Rozpad projektů na úkoly
...
*Budoucnost nepráce — (ne)pracovní sešit · Pro manažery a lídry · © 2025 Filip Dřímalka*
